...
layout = html.Div(children=[
    ...
    html.Ul(children=[
        ...
        html.Li('Let us first see the map of ATP Grand Slam Champions, click and see details! Big 3 dominate the center of the network:)'),
        html.H2('A Network for GS Champions in Tennis History'),
        html.Iframe(
